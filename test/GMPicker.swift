...
class GMPicker: UIView {
    ...
    fileprivate func setup(_ parentVC: UIViewController) {
        ...
        if !placementAnswer.isEmpty{
            
            let i : Int? = Array.index(of: placementAnswer)!
            
            if i != nil {
                gmpicker.selectRow(i!, inComponent: 0, animated: false)
            }else{
                gmpicker.selectRow(0, inComponent: 0, animated: false)
                placementAnswer = Array[0]
            }
